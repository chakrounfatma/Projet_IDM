...
public class ComposantItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composant_marque_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composant_marque_feature", "_UI_Composant_type"),
				 CataloguePackage.Literals.COMPOSANT__MARQUE,
				 true,
				 false,
				 false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composant_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composant_port_feature", "_UI_Composant_type"),
				 CataloguePackage.Literals.COMPOSANT__PORT,
				 true,
				 false,
				 false,
	...
	protected void addCataloguePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composant_catalogue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composant_catalogue_feature", "_UI_Composant_type"),
				 CataloguePackage.Literals.COMPOSANT__CATALOGUE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CataloguePackage.Literals.COMPOSANT__CONTRAINTE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMPOSANT__CONTRAINTE,
				 CatalogueFactory.eINSTANCE.createContrainte()));
	}
