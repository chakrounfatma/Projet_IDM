...
public class ContrainteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contrainte_texte_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contrainte_texte_feature", "_UI_Contrainte_type"),
				 CataloguePackage.Literals.CONTRAINTE__TEXTE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Contrainte)object).getTexte();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Contrainte.class)) {
			case CataloguePackage.CONTRAINTE__TEXTE:
