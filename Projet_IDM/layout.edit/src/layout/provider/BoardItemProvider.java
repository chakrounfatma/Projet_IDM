...
public class BoardItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Board_layout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Board_layout_feature", "_UI_Board_type"),
				 LayoutPackage.Literals.BOARD__LAYOUT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LayoutPackage.Literals.BOARD__COUCHE_INTERNE);
			childrenFeatures.add(LayoutPackage.Literals.BOARD__COUCHE_EXTERNE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LayoutPackage.Literals.BOARD__COUCHE_INTERNE,
				 LayoutFactory.eINSTANCE.createCouche_interne()));

		newChildDescriptors.add
			(createChildParameter
				(LayoutPackage.Literals.BOARD__COUCHE_EXTERNE,
				 LayoutFactory.eINSTANCE.createCouche_externe()));
	}
