...
public class CataloguePackageImpl extends EPackageImpl implements CataloguePackage {
	 ...
	 */
	@Override
	public EAttribute getContrainte_Texte() {
	...
	public void createPackageContents() {
		...
		createEAttribute(contrainteEClass, CONTRAINTE__TEXTE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getContrainte_Texte(), ecorePackage.getEString(), "texte", null, 0, 1, Contrainte.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
