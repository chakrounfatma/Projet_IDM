...
public interface CataloguePackage extends EPackage {
	...
	/**
	 * Returns the meta object for the attribute '{@link catalogue.Contrainte#getTexte <em>Texte</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Texte</em>'.
	 * @see catalogue.Contrainte#getTexte()
	 * @see #getContrainte()
	 * @generated
	 */
	EAttribute getContrainte_Texte();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute CONTRAINTE__TEXTE = eINSTANCE.getContrainte_Texte();
