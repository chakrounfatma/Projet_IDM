...
/**
 * This is the item provider adapter for a {@link netlist.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_connexion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_connexion_feature", "_UI_Port_type"),
				 NetlistPackage.Literals.PORT__CONNEXION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetlistPackage.Literals.PORT__NOM,
				 true,
				 false,
				 false,
