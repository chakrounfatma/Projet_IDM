 ...
 * @generated
 */
public class CommentaireItemProvider extends ElementItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInstancecompPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Instancecomp feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInstancecompPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Commentaire_instancecomp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Commentaire_instancecomp_feature", "_UI_Commentaire_type"),
				 NetlistPackage.Literals.COMMENTAIRE__INSTANCECOMP,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Commentaire)object).getId();
