...
public interface NetlistPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Netlistcom</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COMMENTAIRE__NETLISTCOM = ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int COMMENTAIRE__INSTANCECOMP = ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int COMMENTAIRE__TEXTE = ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int COMMENTAIRE_FEATURE_COUNT = ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the reference '{@link netlist.Commentaire#getNetlistcom <em>Netlistcom</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Netlistcom</em>'.
	 * @see netlist.Commentaire#getNetlistcom()
	 * @see #getCommentaire()
	 * @generated
	 */
	EReference getCommentaire_Netlistcom();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Netlistcom</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COMMENTAIRE__NETLISTCOM = eINSTANCE.getCommentaire_Netlistcom();
