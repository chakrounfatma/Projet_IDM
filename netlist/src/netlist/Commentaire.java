 ...
 * </p>
 * <ul>
 *   <li>{@link netlist.Commentaire#getNetlistcom <em>Netlistcom</em>}</li>
...
public interface Commentaire extends Element {
	/**
	 * Returns the value of the '<em><b>Netlistcom</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Netlistcom</em>' reference.
	 * @see #setNetlistcom(Netlist)
	 * @see netlist.NetlistPackage#getCommentaire_Netlistcom()
	 * @model
	 * @generated
	 */
	Netlist getNetlistcom();

	/**
	 * Sets the value of the '{@link netlist.Commentaire#getNetlistcom <em>Netlistcom</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Netlistcom</em>' reference.
	 * @see #getNetlistcom()
	 * @generated
	 */
	void setNetlistcom(Netlist value);
